...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260415190435_addedDriverIdInJObCard")]
    partial class addedDriverIdInJObCard
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.AttendanceRecord", b =>
                {
                    ...
                    b.HasIndex("BranchId", "WorkDate")
                        .HasDatabaseName("ix_attendance_branch_date");

                    b.HasIndex("EmployeeUserId", "WorkDate")
                        .IsUnique()
            ...
            modelBuilder.Entity("Domain.Entities.CommunicationLog", b =>
                {
                    ...
                    b.HasIndex("JobCardId", "OccurredAt")
                        .HasDatabaseName("ix_commlogs_jobcard_date");
            ...
            modelBuilder.Entity("Domain.Entities.Driver", b =>
                {
                    ...
                    b.HasIndex("CustomerId")
                        .HasDatabaseName("ix_drivers_customer");
            ...
            modelBuilder.Entity("Domain.Entities.JobCard", b =>
                {
                    ...
                    b.Property<string>("LatestDiagnosisSummary")
                        .HasColumnType("text")
                        .HasColumnName("latest_diagnosis_summary");

                    b.Property<DateTimeOffset?>("LatestEstimatedEta")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("latest_estimated_eta");

                    b.Property<decimal?>("LatestEstimatedPrice")
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("latest_estimated_price");

                    b.Property<int?>("Mileage")
                        .HasColumnType("integer")
                        .HasColumnName("mileage");

                    b.Property<DateTimeOffset?>("RequestedEta")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("requested_eta");
            ...
            modelBuilder.Entity("Domain.Entities.JobCardDiagnosisLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("DiagnosisNote")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("diagnosis_note");

                    b.Property<DateTimeOffset?>("EstimatedEta")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("estimated_eta");
                    ...
                    b.HasIndex("JobCardId", "CreatedAt")
                        .HasDatabaseName("ix_jobcard_diagnosis_logs_jobcard_created");

                    b.ToTable("jobcard_diagnosis_logs", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Notification", b =>
                {
                    ...
                    b.HasIndex("BranchId")
                        .HasDatabaseName("ix_notifications_branch");
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasIndex("RefreshToken")
                        .IsUnique()
                        .HasDatabaseName("uq_users_refresh_token");
