...
public sealed record PurchaseOrderResponse(Guid Id, Guid BranchId, Guid SupplierId, string OrderNo, PurchaseOrderStatus Status, DateTimeOffset? OrderedAt, DateTimeOffset? ReceivedAt, string? Notes, string? SupplierName = null);
